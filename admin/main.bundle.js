...
var map = {
	...
	"./add-medicine/add-medicine.module": [
	...
	"./dosage-size/dosage-size.module": [
	...
	"./list-medicine/list-medicine.module": [
		...
		"common",
		"list-medicine.module"
	],
	"./list-orders/list-orders.module": [
	...
	"./theme/chemist/chemist.module": [
		"../../../../../src/app/theme/chemist/chemist.module.ts",
		"chemist.module"
	],
	...
	"./theme/measurements/measurements.module": [
		"../../../../../src/app/theme/measurements/measurements.module.ts",
		"measurements.module"
	],
	"./theme/medicine/medicine.module": [
		"../../../../../src/app/theme/medicine/medicine.module.ts",
		"medicine.module"
	],
	...
	"./theme/orders/orders.module": [
		"../../../../../src/app/theme/orders/orders.module.ts",
		"orders.module"
	],
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'chemist',
                loadChildren: './theme/chemist/chemist.module#ChemistModule'
            },
            {
                path: 'category',
            ...
            {
                path: 'location',
                loadChildren: './theme/location/location.module#LocationModule'
            },
            {
                path: 'medicine',
                loadChildren: './theme/medicine/medicine.module#MedicineModule'
            },
            {
                path: 'measurements',
                loadChildren: './theme/measurements/measurements.module#MeasurementModule'
            },
            {
                path: 'category',
                loadChildren: './theme/category/category.module#CategoryModule'
...
var AdminComponent = (function () {
    ...
    AdminComponent.prototype.logout = function () {
        localStorage.setItem('session_obj', null);
    };
        ...
        if (this.UserRole == 1) {
            for (var i = 0; i < this.custom_menu_items.length; i++) {
                for (var j = 0; j < this.custom_menu_items[i].main.length; j++) {
                    ...
                    if (this.custom_menu_items[i].main[j].name == 'Category') {
                        this.custom_menu_items[i].main[j].show = true;
                    }
                    if (this.custom_menu_items[i].main[j].name == 'Product') {
                        this.custom_menu_items[i].main[j].show = true;
                    }
                    if (this.custom_menu_items[i].main[j].name == 'Orders') {
                        this.custom_menu_items[i].main[j].show = true;
                    }
                    if (this.custom_menu_items[i].main[j].name == 'City') {
                        this.custom_menu_items[i].main[j].show = true;
                    }
                    ...
                    if (this.custom_menu_items[i].main[j].name == 'Dosage Size') {
                        this.custom_menu_items[i].main[j].show = true;
                    }
                }
            }
...
var TitleComponent = (function () {
    function TitleComponent(router, route, titleService) {
        ...
        this.router.events
            ...
            if (title !== undefined) {
                _this.titleService.setTitle('Pharma | Admin Portal');
            }
        });
    }
